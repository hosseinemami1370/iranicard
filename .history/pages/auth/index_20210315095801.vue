 ...
 <div class="admin-auth-page">
  ...
  <b-card title="LOGIN" style="max-with:10rem" class="mt-5 text-center" img-src="@/assets/download.png" img-top>
      <b-form @submit.prevent="onSubmit">
          <b-form-input  id="email" required v-model="$v.email.$model" placeholder="Enter Email">

          </b-form-input>
          <p class="error" v-if="!$v.email.required">this field is required</p>
<p class="error" v-if="!$v.formResponses.name.minLength">Field must have at least {{ $v.email.$params.minLength.min }} characters.</p>
          <b-form-input type="password" class="mt-2" required id="password" v-model="password" placeholder="Enter passworf">
